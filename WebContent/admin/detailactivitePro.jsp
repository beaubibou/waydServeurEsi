...
<body>
	...
	<%
		...
		return;
			...
			ArrayList<SignalementActiviteBean> listSignalement = SignalementDAO.getListSignalementActivite(activite.getId());
	%>
	...
	<div class="container">
		...
		<button type="button" class="btn btn-info" data-toggle="collapse"
			data-target="#amis">Signalement (<%=listSignalement.size() %>)</button>
