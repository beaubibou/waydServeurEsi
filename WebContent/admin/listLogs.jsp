	...
	<script>
		$(function() {
			...
			$('#datedebut').datetimepicker({
				defaultDate : new Date(	<%=filtreLogs.getDateCreationDebut().getYear()%>,<%=filtreLogs.getDateCreationDebut().getMonthOfYear()%>-1,<%=filtreLogs.getDateCreationDebut().getDayOfMonth()%>),
				format : 'DD/MM/YYYY'
			...
			$('#datefin').datetimepicker(
					{
						defaultDate : new Date(<%=filtreLogs.getDateCreationFin().getYear()%>,<%=filtreLogs.getDateCreationFin().getMonthOfYear()-1%>,<%=filtreLogs.getDateCreationFin().getDayOfMonth()%>),
								format : 'DD/MM/YYYY'
