...
<body>
	...
	<%
		...
		ArrayList<CountLogInfo> listCountInfo = LogDAO.getStatLogs();
	...
	<div class="container" style="width: 90%;">
		...
		<table class="table table-striped">
			...
			<tbody>
				...
				<tr style="font-weight:bold;background-color:<%=countLogInfo.getCouleur()%> ">

					<td ><%=countLogInfo.getDate()%></td>
			
					<td ><a href='<%=countLogInfo.getLienHtlm() %>'><%=countLogInfo.getLog_level()%></a></td>
					</a>
					<td><%=countLogInfo.getNbr()%></td>
