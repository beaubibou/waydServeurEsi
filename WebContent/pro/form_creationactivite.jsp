...
<div class="container">
  ...
  <form action="/wayd/AjouteActivite" onsubmit="return valideFormulaire()" method="post">
   ...
   <label for="typeactivite">Type d'activitée:</label>
    ...
    <div class="form-group">
    <div class="row">
		<div class='col-sm-2'> <label for="iddatedebut">Date debut</label></div>
        <div class='col-sm-4'>
            <div class="form-group">
                <div class='input-group date' id='datedebut'>
                  
                    <input type='text' class="form-control" id="iddatedebut" name="debut" />
        ...
        <div class='col-sm-2'>  <label for="iddatefin">Date fin</label></div>
         <div class='col-sm-4'>
            <div class="form-group">
