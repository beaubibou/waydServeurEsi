	...
	<%}%>
		var_map.addListener('center_changed', function() {
				...
				window.setTimeout(function() {
					...
					lat=centre.lat();
					lon=centre.lng();
					$.get("ListMapActivite?latitude="+lat+"&longitude="+lon, function(responseJson) { // Execute Ajax GET request on URL of "someservlet" and execute the following function with Ajax response JSON...
