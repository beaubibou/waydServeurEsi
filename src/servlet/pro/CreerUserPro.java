...
//		
	...
	private MessageServeur creerUtilisateurDAO(String uuid,String pwd, String pwd1,
		...
		// TODO Auto-generated method stub
			...
			return new MessageServeur(false,"Erreur pendant la cr̩atio en base de donn̩e");
...
private MessageServeur testParametreRequete(String pwd, String pwd1,
	...
	if (PersonneDAO.isPseudoExist(pseudo))
		new MessageServeur(false,"Le nom existe d̩ja");
	
	if (pwd==null)return new MessageServeur(false,"Mot de passe ne peut pas ̻tre vide");
	if (pwd.length()<6)return new MessageServeur(false,"Le mot de passe doit faire 6 caract̩res");
