...
//	private String datecreationstr;
	...
	public ProfilNotation(int id, String nom, String prenom, String ville,
			Date datecreation, Date datenaissance, int nbravis,
			int sexe, int nbractivite, int nbrparticipation, int nbrami,
			double note, String photostr, boolean affichesexe,boolean afficheage,String commentaire,boolean ami,String titreActivite) {
		super();
		this.id = id;
		this.nom = nom;
		this.prenom = prenom;
	...
	public ProfilNotation(Profil p,boolean ami,String titreActivite) {
		super();
		this.id = p.getId();
		this.nom = p.getNom();
		this.prenom = p.getPrenom();
		this.ville = p.getVille();
		this.nbravis =p. getNbravis();
		this.sexe =p. getSexe();
		this.nbractivite = p.getNbractivite();
		this.nbrparticipation =p. getNbrparticipation();
		this.nbrami =p. getNbrami();
		this.note = p.getNote();
		this.photostr =p. getPhotostr();
		this.age=p.getAge();
		//if (affichesexe)this.sexe=3;
	...
	public ProfilNotation(Personne personne) {
