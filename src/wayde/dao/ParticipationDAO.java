...
public class ParticipationDAO {
	...
	static final int ATTENTE_REPONSE = 0;
	static final int ACCEPT_AMI = 1;
	static final int REFUSE_AMI = 0;
	...
	public void addNotation(Participation participation) throws SQLException {
		...
		try {
			...
			preparedStatement
					.setInt(3, (int) participation.getIdorganisateur());
			...
			preparedStatement = connexion.prepareStatement(requete);
			preparedStatement
					.setInt(1, (int) participation.getIdorganisateur());
			preparedStatement.setInt(2, (int) participation.getIdactivite());
	...
	public void RemoveParticipation(int idpersonne, int idactivite,
			int idorganisateur) throws SQLException {
		PreparedStatement preparedStatement = null;
	...
	public ArrayList<Personne> getListPartipantActivite(int idactivite)
			throws Exception {
	...
	public int getNombreParticipant(int idactivite, int personne)
			throws Exception {
	...
	public ArrayList<Personne> getListPartipantActiviteExpect(int idactivite,
			int idexpect) throws SQLException {
	...
	public int getNbrParticipation(int idpersonne) throws SQLException {
		int nbr = 0;
